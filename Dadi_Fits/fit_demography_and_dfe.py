    ...
    def main(self):
        ...
        for model in model_list:
            if model == 'exponential_growth':
                ...
                # 25 initial guesses
                initial_guesses = []
                initial_guesses.append([9, 0.000001])
                initial_guesses.append([9, 0.00001])
                initial_guesses.append([8.5, 0.000001])
                initial_guesses.append([8.5, 0.00001])
                initial_guesses.append([7.5, 0.000001])
                initial_guesses.append([7.5, 0.00001])
                initial_guesses.append([6.5, 0.000001])
                initial_guesses.append([6.5, 0.00001])
