...
/u/project/klohmuel/amzurita/Tools/slim_build/slim -d syn_s=-1e-4 -d recom_rate=1e-8 -d "run_name_output='replicates_E4_Tree_${SGE_TASK_ID}_'" SynSelectionTree_TaskArray.slim
